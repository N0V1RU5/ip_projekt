...
<body class="container">
    <div>
        ...
        while($row = $keys->fetch()){
            $html = $html."<dd><a style='text-decoration:none' href='room.php?roomId={$row['room_id']}'>".htmlspecialchars($row['name'])."</a></dd>";
        }

        $html = $html."</dl>";
        $html = $html."<h3><a style='text-decoration:none' href=employees.php>Zpět na \"Seznam zaměstnanců <i class='bi bi-people-fill'></i>\"</a></h3>";
        echo $html;
    }
        ?>
    </div>
